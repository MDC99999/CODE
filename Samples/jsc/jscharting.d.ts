...
export declare interface JSCChartConfig {
    ...
    /**
     * The fundamental {@link https://jscharting.com/documentation/#node=Home.API.json.Enums.chartType | chart type} such as horizontal or vertical. You can additional {@link https://jscharting.com/documentation/#node=Home.API.json.Enums.seriesType | seriesType enum} values for line, bar, area varieties. For example:"horizontal column" creates a bar chart
